...
<div className='flex pl-24 justify-between  mt-16'>
  <div className='w-4/5'>
    ...
    <div>
    <div className='text-gray-100 my-10 flex items-start justify-between flex-wrap  ' >
          <button className='text-[#FFFFFF] flex bg-[#2ecc71] text-sm py-3  mr-5 my-10 px-6 rounded-xl '>
              Learn More 
      ...
      {/* Social media Icons */}
      <div className='mt-20'>
      <div className=' w-1/5 flex items-center justify-between gap-y-4'>
  ...
  <div className='hero-image lg:-mr-36 xl:-mr-38 ' >
