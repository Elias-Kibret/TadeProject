  ...
  return (
    <div className=" bg-[#141B17] text-white mt-32">
        ...
        <div className=" grid grid-cols-2 gap-x-8 sm:flex sm:flex-col">
           <Link href="/" ><a className="py-1 hover:text-[#2cee71]">Home</a></Link>
           <Link href="/about"><a className="py-1 hover:text-[#2cee71]">About</a></Link>
           <Link href="/whatsnew"><a className="py-1 hover:text-[#2cee71]">What's New</a></Link>
           <Link href="/research"><a className="py-1 hover:text-[#2cee71]">Research</a></Link>
           <Link href="/awards"><a className="py-1 hover:text-[#2cee71]">Awards</a></Link>
